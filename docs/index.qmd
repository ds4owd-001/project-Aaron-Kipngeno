...
@tbl-willingness shows, majority of respondents 76% were willing to investigate. The study investigate the level of willingness, 29% were not willing, 20% very much willing and 48% were willing to invest, with significant associations at p-Value (0.001) as shown in \@tbl-level.

```{r}
#|lable: tbl-willingness
#|tbl-cap: proportion willing to invesrt in sanitaions
sanitation_clean |> 
...
```{r}
#|lable: tbl-level
#|tbl-cap: level of willingness to invest
