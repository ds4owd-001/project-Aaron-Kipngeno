...
kable(tx, caption = " proportion willing to invest in sanitation facilities")
...
tbl<- sanitation_clean |>
  tbl_cross(row = level_of_willingness,
            col = willingness_to_invest,
            percent = "cell") |> 
  add_p()
kable(tbl, caption = "level of willingess to invest in sanitation facilities")
```
