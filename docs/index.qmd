...
library(readr)
library(tidyverse)
knitr::write_bib(c("rmarkdown"), file = "citations.bib")
```
...
#associations of gender,age, religion, know sanitatio, presence of latrine, benefit of use of toilet, sanitation laws

#### #chi-Sqaure test statistics
...
the study investigated influence of employement status, household income , sanitation organizations, knowldge on finacial institutions,
...
e4<- table(sanitation_clean$willingness_to_invest, sanitation_clean$knowledge_on_financial_institutions)
chisq.test(e4)
